...
// let sumPrice = products.reduce((total, product)=>total + product.unitPrice,0);
//reduceRight

// console.log('sum price: ',sumPrice.toFixed(2));

let updatedProducts = products.map((product, idx) => {
...
// let filteredProducts = tempArr.filter((product,idx,arr)=>product.name.trim().toLowerCase().includes('Anton'.toLowerCase().trim()));
// console.log('filtered: ',filteredProducts);

// filteredProducts[0].id = 1234;

// console.log(filteredProducts);

// console.log(filteredProducts[0].unitPrice);
...
const numbers = [41, 3, 11, 15, 23];

console.log(numbers.some((number,idx,arr)=>{
    return number%2==0;
}));
